package com.sebas.firebaseapp_sebas;
...
import com.sebas.firebaseapp_sebas.adapters.PostRVAdapter;
import com.sebas.firebaseapp_sebas.models.Post;
import com.sebas.firebaseapp_sebas.models.User;

import java.util.List;


//YTzWk0lX3r5l5hydFZZxKu5U+C4=
//keytool -exportcert -alias androiddebugkey -keystore ~/.android/debug.keystore | "C:\Users\ALUMNO\openssl\bin\openssl.exe" sha1 -binary | "C:\Users\ALUMNO\openssl\bin\openssl.exe" base64
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bundle.putString("fullname", "Sebastian Rau");
        mFirebaseAnalytics.logEvent(FirebaseAnalytics.Event.APP_OPEN, bundle);

        mFirebaseAnalytics.setUserProperty("username", "srau");

        Log.d(TAG, "user: " + FirebaseAuth.getInstance().getCurrentUser());
